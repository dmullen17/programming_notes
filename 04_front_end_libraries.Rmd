...
### React and Redux boilerplate import
...
+ font-awesome icons register as text.  For instance if you want to apply shadow to one you use `text-shadow` rather `box-shadow`
...
+ you can insert an svg element directly as html.  If you save the file and open it in a text editor you can copy-paste the html into a file. 

The following makes a quaffle svg! 
```<?xml version="1.0" ?><svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><title/><g id="text"><text font-family="MyriadPro-Regular, Myriad Pro" font-size="9" transform="translate(7.84473 -49.60986)"><tspan letter-spacing="-0.00602em" x="12.81592" y="0"/><tspan x="15.74072" y="0"/><tspan letter-spacing="0.00401em" x="20.24951" y="0"/><tspan x="23.22852" y="0"/></text></g><g data-name="Layer 1" id="Layer_1"><path d="M57.70709,25.97894a4.9255,4.9255,0,0,1-.85651,1.01715c-3.54492,3.09375-11.17627.39355-16.66211-5.89453a24.54,24.54,0,0,1-4.05188-6.37012,8.94248,8.94248,0,0,1,8.42065-8.6405A28.053,28.053,0,0,1,57.70709,25.97894ZM50,30a19.76848,19.76848,0,0,1-3.72943,11.60577c-3.62518-1.54517-8.63342-1.86072-13.94684-.58917a23.18353,23.18353,0,0,0-11.89667,6.54523,20.19593,20.19593,0,0,1-8.17468-8.36664,23.37054,23.37054,0,0,0,6.48541-11.68347,24.151,24.151,0,0,0,.04346-12.46094c-.13251-.44586-.28259-.86993-.44391-1.27887A19.76872,19.76872,0,0,1,30,10a20.20442,20.20442,0,0,1,2.78754.2157A23.205,23.205,0,0,0,38.68164,22.416a23.2014,23.2014,0,0,0,11.31665,7.51147C49.99835,29.95178,50,29.97571,50,30ZM32.78955,42.96191c5.616-1.34418,11.06842-.691,14.25964,1.35406-8.8808-1.46741-20.1687,1.00146-27.13989,8.14215C20.95386,48.54828,26.13275,44.556,32.78955,42.96191ZM3.65527,39.48029A27.73856,27.73856,0,0,1,2.59161,35.7298a7.48558,7.48558,0,0,0,3.1911.95184c.19092.01367.39111.02148.6001.02148a13.2925,13.2925,0,0,0,7.574-2.80652c-2.6026,4.2475-6.18756,6.752-9.30981,5.9657A4.84987,4.84987,0,0,1,3.65527,39.48029ZM34.94635,10.84106c-.52808-2.9809-.0296-5.56915,1.666-7.0481a4.88747,4.88747,0,0,1,1.108-.7019A27.77565,27.77565,0,0,1,41.748,4.593,11.00675,11.00675,0,0,0,34.94635,10.84106ZM35.11176,2.476a8.14075,8.14075,0,0,0-2.39722,5.7113A22.17088,22.17088,0,0,0,30,8a21.74628,21.74628,0,0,0-12.56012,3.95392A7.95024,7.95024,0,0,0,12.629,8.06409,27.8643,27.8643,0,0,1,35.11176,2.476ZM10.55981,9.87683a4.92219,4.92219,0,0,1,1.54126.1134c2.15186.53613,3.84375,2.53613,4.76318,5.62988a22.1429,22.1429,0,0,1-.06689,11.40723,25.91742,25.91742,0,0,1-.77533,2.52051C12.42255,33.064,8.85034,34.899,5.92432,34.68652a5.4774,5.4774,0,0,1-3.78308-1.87469Q2.00226,31.42435,2,30A27.91318,27.91318,0,0,1,10.55981,9.87683ZM4.65967,41.89526a7.03331,7.03331,0,0,0,1.19873.11548,8.79562,8.79562,0,0,0,4.79138-1.56781,22.218,22.218,0,0,0,8.55585,8.71729A8.12912,8.12912,0,0,0,17.85834,55.228,28.17852,28.17852,0,0,1,4.65967,41.89526ZM30,58a27.86982,27.86982,0,0,1-9.6109-1.69952,4.95491,4.95491,0,0,1-.41064-.90533c6.948-8.68085,20.30725-11.13257,29.4657-8.50623a4.76,4.76,0,0,1,.33807.93042,5.00256,5.00256,0,0,1,.07013,1.90491A27.91226,27.91226,0,0,1,30,58ZM51.77,47.582c-.01538-.07562-.02454-.15234-.04248-.22748a7.93056,7.93056,0,0,0-3.6759-4.80225A21.72439,21.72439,0,0,0,51.989,30.26984c.32361.02844.644.04657.95831.04657A7.80481,7.80481,0,0,0,57.966,28.66058c.021.44409.034.89026.034,1.33942A27.86226,27.86226,0,0,1,51.77,47.582Z"/></g></svg>```

### defs 
Inside an <svg> we can add a `<defs>` object.  We can definition syntax that we want to reference in an element's attributes. For instance here we create a `linear-gradient` that we reference in the `svg`'s `fill` property. 

```
<defs>
      <linearGradient id="snitchGradient" x1=".5" x2=".5" y1='1' y2='0'>
        <stop offset="0%" stop-color="gold"/>
        <stop offset="30%" stop-color="#f4ce04"/>
        <stop offset="46%" stop-color='white'/>
...
### keyframes 
We can create CSS animations with keyframes.  These animantions mimic a screensaver.  We set the `top` and `left` css properties to oscillate from 0-100%.  Then in the animations property of a class we can set them to repeat infinitely.  Using an offset number of seconds creates a different pattern.  

```
.spinning {
  animation: horizontal 12s infinite linear, vertical 20s infinite ease, rotation 3s infinite linear;
}
