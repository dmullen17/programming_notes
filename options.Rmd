...
Do not sell puts or calls around an earnings report.  This is when the greatest fluctuations usually occur.  Technology stocks are usually more volatile - they recommend insurance, service, and financial companies.  

ETFs do not have to be concerned with earnings and revenues that you have to consider when trading stocks. In some cases, ETFs may pay lower premiums than stocks. The best time to trade puts is when a stock or ETF is down on a trading day, and the best time to trade calls is when the stock or ETF is up on a trading day. You will receive the most premium income on these days.
...
10. What is Harrison's robinhood account?  Has he considered using a Roth IRA?
